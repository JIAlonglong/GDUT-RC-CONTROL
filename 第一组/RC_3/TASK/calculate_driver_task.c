...
{	
	...
	while(1)
	{
		...
		// 速度分解
		{
		ROBOT_TARGET_VELOCITY_DATA.Vx_RPM=(ROCK_R_X-1500)*2;
		ROBOT_TARGET_VELOCITY_DATA.Vy_RPM=(ROCK_R_Y-1500)*2;
		ROBOT_TARGET_VELOCITY_DATA.W_RPM=-(ROCK_L_Y-1500)*2;
    ...
    if(fine_turning_state==1)
		...
		if(SWA>1500&&SWD>1500&&ok==1)
		{
	    if(LaserLockPoint(ladar_distance ,ladar_yaw,800,500))
			{
				ok=0;
