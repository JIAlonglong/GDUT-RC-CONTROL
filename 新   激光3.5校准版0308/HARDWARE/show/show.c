...
void oled_show()
{
     R0 = (int) ( 0.5346*adc_update_ranging_distance(0)- 35.163);//左上角  上
  R4 = adc_update_ranging_distance(4);//左下角  下
//     R3 = (int)(adc_update_ranging_distance(3));//右上角
   R3 = (int)(1.1841*adc_update_ranging_distance(3)- 27.892);//右上角               激光
	   VisionSendData(R0,R3);
// {
