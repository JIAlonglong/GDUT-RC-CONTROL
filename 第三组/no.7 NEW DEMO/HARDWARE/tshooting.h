...
#define TMOTOR_ID1 0x01//要使用的TMOTORID
...
void TMOTOR_Speed_Control(u8 ID,float vel);///速度模式控制TMOTOR
...
void TMOTORSHOOTING_Init(void);//初始化TMOTOR
...
void TMOTOR_control_cmd(uint8_t ID,uint8_t cmd);//模式控制
