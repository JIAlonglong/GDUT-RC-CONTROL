...
//				LockupPoint(CUR_POS[0], CUR_POS[1], CUR_POS[2]);
			...
			case MOVE_1_RESTART:
				move_time_counter += 0.01f;
			if(moving_point_track(move_time_counter,-6227, 100, 0,800))//取环点
				{
					move_time_counter = 0;
					MOVE_STATE = MOVE_STOP;
				}
			...
			case MOVE_1_SHOOT_CLOSE:
				move_time_counter += 0.01f;
			if(moving_point_track(move_time_counter,-5780, 690, 0,250))
				{
					move_time_counter = 0;
					MOVE_STATE = MOVE_STOP;
				}
			...
			case MOVE_3_SHOOT_CLOSE:
				move_time_counter += 0.01f;
			if(moving_point_track(move_time_counter,-598, 1123, 0,250))
				{
					move_time_counter = 0;
					MOVE_STATE = MOVE_STOP;
				}
			...
			case MOVE_JI:
				move_time_counter += 0.01f;
			if(moving_point_track(move_time_counter,-4086, 4882, 0,250))
				{
					move_time_counter = 0;
					MOVE_STATE = MOVE_STOP;
				}
