...
void ad_plan_arm_motor_RPM_TRANSATE(TRANSATE_VELOCITY_PLANNING motion, 							float pos			)	;


extern struct M3508_REAL_INFO M3508_CHASSIS_MOTOR_REAL_INFO[3];//三轮底盘
extern struct PID M3508_CHASSIS_MOTOR_PID_RPM[3];    			 // 驱动M3508电机
#endif
